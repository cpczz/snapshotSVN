...
-- DELTA Desarrollo
select 'svn export --username UsuarioSubversion --password PasswordUsuarioSubversion --revision '||versiondesarrollo||' ' ||cod_repositorio||RamaDesarrollo||' Fuentes-DESA' as extraer from ControlDeVersionesSinBatch;
