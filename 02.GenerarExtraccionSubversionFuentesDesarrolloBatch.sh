## +---------------------------------------------------------------------------+
## |                                                                           |
## | PROGRAM: 02.GenerarExtraccionSubversionFuentesDesarrolloBatch.sh          |
## |                                                                           |
## | USAGE  : 02.GenerarExtraccionSubversionFuentesDesarrolloBatch.sh          |
## |                                                                           |
## |                                                                           |
## | Description:                                                              |
## |                                                                           |
...
@02.GenerarExtraccionSubversionFuentesDesarrolloBatch.sql
EOF
