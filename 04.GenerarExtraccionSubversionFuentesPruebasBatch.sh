## +---------------------------------------------------------------------------+
## |                                                                           |
## | PROGRAM: 04.GenerarExtraccionSubversionFuentesPruebasBatch.sh             |
## |                                                                           |
## | USAGE  : 04.GenerarExtraccionSubversionFuentesPruebasBatch.sh             |
## |                                                                           |
## |                                                                           |
## | Description:                                                              |
## |                                                                           |
...
@04.GenerarExtraccionSubversionFuentesPruebasBatch.sql
EOF
