## +---------------------------------------------------------------------------+
## |                                                                           |
## | PROGRAM: 05.GenerarExtraccionSubversionFuentesProduccion.sh               |
## |                                                                           |
## | USAGE  : 05.GenerarExtraccionSubversionFuentesProduccion.sh               |
## |                                                                           |
## |                                                                           |
## | Description:                                                              |
## |                                                                           |
...
@05.GenerarExtraccionSubversionFuentesProduccion.sql
EOF
