## +---------------------------------------------------------------------------+
## |                                                                           |
## | PROGRAM: 06.GenerarExtraccionSubversionFuentesProduccionBatch.sh          |
## |                                                                           |
## | USAGE  : 06.GenerarExtraccionSubversionFuentesProduccionBatch.sh          |
## |                                                                           |
## |                                                                           |
## | Description:                                                              |
## |                                                                           |
...
@06.GenerarExtraccionSubversionFuentesProduccionBatch.sql
EOF
